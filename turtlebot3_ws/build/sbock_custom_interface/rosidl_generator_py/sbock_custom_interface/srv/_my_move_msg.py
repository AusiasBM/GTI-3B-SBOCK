...
class Metaclass_MyMoveMsg(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'sbock_custom_interface.srv.MyMoveMsg')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from sbock_custom_interface.srv import _my_move_msg
...
class MyMoveMsg(metaclass=Metaclass_MyMoveMsg):
    from sbock_custom_interface.srv._my_move_msg import MyMoveMsg_Request as Request
    from sbock_custom_interface.srv._my_move_msg import MyMoveMsg_Response as Response
