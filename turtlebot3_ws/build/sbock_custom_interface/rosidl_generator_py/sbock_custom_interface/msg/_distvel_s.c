...
bool sbock_custom_interface__msg__distvel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sbock_custom_interface.msg._distvel.Distvel", full_classname_dest, 43) == 0);
  }
  sbock_custom_interface__msg__Distvel * ros_message = _ros_message;
  {  // distancia
...
PyObject * sbock_custom_interface__msg__distvel__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sbock_custom_interface.msg._distvel");
