...
static const _MyMoveMsg_Request_type_support_symbol_names_t _MyMoveMsg_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sbock_custom_interface, srv, MyMoveMsg_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sbock_custom_interface, srv, MyMoveMsg_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sbock_custom_interface, srv, MyMoveMsg_Request)() {
  return &::sbock_custom_interface::srv::rosidl_typesupport_c::MyMoveMsg_Request_message_type_support_handle;
}
...
static const _MyMoveMsg_Response_type_support_symbol_names_t _MyMoveMsg_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sbock_custom_interface, srv, MyMoveMsg_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sbock_custom_interface, srv, MyMoveMsg_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_sbock_custom_interface
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sbock_custom_interface, srv, MyMoveMsg_Response)() {
  return &::sbock_custom_interface::srv::rosidl_typesupport_c::MyMoveMsg_Response_message_type_support_handle;
}
...
static const _MyMoveMsg_type_support_symbol_names_t _MyMoveMsg_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sbock_custom_interface, srv, MyMoveMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sbock_custom_interface, srv, MyMoveMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, sbock_custom_interface, srv, MyMoveMsg)() {
  return &::sbock_custom_interface::srv::rosidl_typesupport_c::MyMoveMsg_service_type_support_handle;
}
