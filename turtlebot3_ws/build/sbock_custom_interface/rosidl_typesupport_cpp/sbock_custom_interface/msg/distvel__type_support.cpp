...
static const _Distvel_type_support_symbol_names_t _Distvel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sbock_custom_interface, msg, Distvel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sbock_custom_interface, msg, Distvel)),
  }
};
...
{
  return &::sbock_custom_interface::msg::rosidl_typesupport_cpp::Distvel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sbock_custom_interface, msg, Distvel)() {
  return get_message_type_support_handle<sbock_custom_interface::msg::Distvel>();
}
