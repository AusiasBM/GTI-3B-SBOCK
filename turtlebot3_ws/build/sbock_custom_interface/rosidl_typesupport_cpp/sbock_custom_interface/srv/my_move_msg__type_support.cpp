...
static const _MyMoveMsg_Request_type_support_symbol_names_t _MyMoveMsg_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sbock_custom_interface, srv, MyMoveMsg_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sbock_custom_interface, srv, MyMoveMsg_Request)),
  }
};
...
{
  return &::sbock_custom_interface::srv::rosidl_typesupport_cpp::MyMoveMsg_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sbock_custom_interface, srv, MyMoveMsg_Request)() {
  return get_message_type_support_handle<sbock_custom_interface::srv::MyMoveMsg_Request>();
}
...
static const _MyMoveMsg_Response_type_support_symbol_names_t _MyMoveMsg_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sbock_custom_interface, srv, MyMoveMsg_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sbock_custom_interface, srv, MyMoveMsg_Response)),
  }
};
...
{
  return &::sbock_custom_interface::srv::rosidl_typesupport_cpp::MyMoveMsg_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sbock_custom_interface, srv, MyMoveMsg_Response)() {
  return get_message_type_support_handle<sbock_custom_interface::srv::MyMoveMsg_Response>();
}
...
static const _MyMoveMsg_type_support_symbol_names_t _MyMoveMsg_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sbock_custom_interface, srv, MyMoveMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sbock_custom_interface, srv, MyMoveMsg)),
  }
};
...
{
  return &::sbock_custom_interface::srv::rosidl_typesupport_cpp::MyMoveMsg_service_type_support_handle;
}
