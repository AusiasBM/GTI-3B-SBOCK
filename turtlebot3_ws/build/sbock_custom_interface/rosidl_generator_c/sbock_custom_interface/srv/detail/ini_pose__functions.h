...
#ifndef SBOCK_CUSTOM_INTERFACE__SRV__DETAIL__INI_POSE__FUNCTIONS_H_
#define SBOCK_CUSTOM_INTERFACE__SRV__DETAIL__INI_POSE__FUNCTIONS_H_
...
/// Initialize srv/IniPose message.
/**
...
/// Create srv/IniPose message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * sbock_custom_interface__srv__IniPose_Request__init().
...
/// Destroy srv/IniPose message.
/**
 * It calls
 * sbock_custom_interface__srv__IniPose_Request__fini()
...
/// Initialize array of srv/IniPose messages.
/**
...
/// Finalize array of srv/IniPose messages.
/**
 * It calls
 * sbock_custom_interface__srv__IniPose_Request__fini()
...
/// Create array of srv/IniPose messages.
/**
 * It allocates the memory for the array and calls
 * sbock_custom_interface__srv__IniPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/IniPose messages.
/**
 * It calls
 * sbock_custom_interface__srv__IniPose_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * sbock_custom_interface__srv__IniPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sbock_custom_interface
...
/**
 * It calls
 * sbock_custom_interface__srv__IniPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_sbock_custom_interface
...
/**
 * It allocates the memory for the array and calls
 * sbock_custom_interface__srv__IniPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sbock_custom_interface
...
/**
 * It calls
 * sbock_custom_interface__srv__IniPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SBOCK_CUSTOM_INTERFACE__SRV__DETAIL__INI_POSE__FUNCTIONS_H_
