...
#include "sbock_custom_interface/srv/detail/my_move_msg__rosidl_typesupport_fastrtps_c.h"
...
using _MyMoveMsg_Request__ros_msg_type = sbock_custom_interface__srv__MyMoveMsg_Request;
...
size_t get_serialized_size_sbock_custom_interface__srv__MyMoveMsg_Request(
  const void * untyped_ros_message,
...
static uint32_t _MyMoveMsg_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sbock_custom_interface__srv__MyMoveMsg_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sbock_custom_interface
size_t max_serialized_size_sbock_custom_interface__srv__MyMoveMsg_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_sbock_custom_interface__srv__MyMoveMsg_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sbock_custom_interface, srv, MyMoveMsg_Request)() {
...
using _MyMoveMsg_Response__ros_msg_type = sbock_custom_interface__srv__MyMoveMsg_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sbock_custom_interface
size_t get_serialized_size_sbock_custom_interface__srv__MyMoveMsg_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MyMoveMsg_Response__ros_msg_type * ros_message = static_cast<const _MyMoveMsg_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_sbock_custom_interface__srv__MyMoveMsg_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sbock_custom_interface
size_t max_serialized_size_sbock_custom_interface__srv__MyMoveMsg_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_sbock_custom_interface__srv__MyMoveMsg_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sbock_custom_interface, srv, MyMoveMsg_Response)() {
...
// already included above
// #include "sbock_custom_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "sbock_custom_interface/srv/my_move_msg.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sbock_custom_interface, srv, MyMoveMsg)() {
