...
#include "sbock_custom_interface/msg/detail/distvel__rosidl_typesupport_fastrtps_c.h"
...
using _Distvel__ros_msg_type = sbock_custom_interface__msg__Distvel;
...
size_t get_serialized_size_sbock_custom_interface__msg__Distvel(
  const void * untyped_ros_message,
...
static uint32_t _Distvel__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sbock_custom_interface__msg__Distvel(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sbock_custom_interface
size_t max_serialized_size_sbock_custom_interface__msg__Distvel(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_sbock_custom_interface__msg__Distvel(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_Distvel = {
  "sbock_custom_interface::msg",
  "Distvel",
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sbock_custom_interface, msg, Distvel)() {
