...
#include "sbock_custom_interface/srv/detail/my_move_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sbock_custom_interface::srv::MyMoveMsg_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sbock_custom_interface::srv::MyMoveMsg_Request & ros_message)
{
  // Member: move
  cdr >> ros_message.move;
...
{
  auto typed_message =
    static_cast<const sbock_custom_interface::srv::MyMoveMsg_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sbock_custom_interface::srv::MyMoveMsg_Request *>(
    untyped_ros_message);
...
{
  return &sbock_custom_interface::srv::typesupport_fastrtps_cpp::_MyMoveMsg_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sbock_custom_interface, srv, MyMoveMsg_Request)() {
  return &sbock_custom_interface::srv::typesupport_fastrtps_cpp::_MyMoveMsg_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sbock_custom_interface
cdr_serialize(
  const sbock_custom_interface::srv::MyMoveMsg_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sbock_custom_interface::srv::MyMoveMsg_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const sbock_custom_interface::srv::MyMoveMsg_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<sbock_custom_interface::srv::MyMoveMsg_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &sbock_custom_interface::srv::typesupport_fastrtps_cpp::_MyMoveMsg_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sbock_custom_interface, srv, MyMoveMsg_Response)() {
  return &sbock_custom_interface::srv::typesupport_fastrtps_cpp::_MyMoveMsg_Response__handle;
}
...
{
  return &sbock_custom_interface::srv::typesupport_fastrtps_cpp::_MyMoveMsg__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sbock_custom_interface, srv, MyMoveMsg)() {
  return &sbock_custom_interface::srv::typesupport_fastrtps_cpp::_MyMoveMsg__handle;
}
