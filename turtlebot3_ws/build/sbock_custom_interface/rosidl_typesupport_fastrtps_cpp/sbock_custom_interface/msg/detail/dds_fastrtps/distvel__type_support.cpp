...
#include "sbock_custom_interface/msg/detail/distvel__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const sbock_custom_interface::msg::Distvel *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sbock_custom_interface::msg::Distvel *>(
    untyped_ros_message);
...
{
  return &sbock_custom_interface::msg::typesupport_fastrtps_cpp::_Distvel__handle;
}
